//
// Advent of Code 2017, day 16, part two
//
...
int main()
{
	...
	for (std::size_t i = 1; i <= 1'000'000'000L; ++i) {
		...
		// Look for cycle
		if (auto [it, success] = lookup.insert({programs, i}); !success) {
			auto period = i - it->second;
			std::cout << seen[(1'000'000'000L - it->second) % period] << '\n';
			break;
		}
	}
}
